	...
	return (
		<div style={{ backgroundImage: `url(${bgImage})` }} className='bg-cover relative w-screen text-3xl gap-5 h-screen'>
			<div className='w-full h-full bg-[rgba(0,0,0,0.7)] flex items-center flex-col justify-center gap-10'>
				...
				<img src={detective} className='hidden lg:block absolute bottom-0 left-0 h-full' />
				<p className='text-gray-300 text-center lg:text-left absolute bottom-5 gap-1 flex md:text-lg mt-5 bg-[rgba(0,0,0,0.6)] py-3 text-sm px-2'>
